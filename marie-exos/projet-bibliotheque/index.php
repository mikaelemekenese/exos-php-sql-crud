...
<div class="container">
	...
	<br><div class="home-buttons">
		...
		<div class="home-empr">
			...
			<a type="button" class="btn btn-info" href="empr-read.php"><h5>Consulter les emprunts</h5></a><br>
			<a type="button" class="btn btn-success" href="empr-create.php"><h5>Emprunter</h5></a>
		</div>
